...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/saleVisit_find.action"
		method=post>
									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间：</TD>
													<TD>从<INPUT class=textbox id="visit_time" 
														style="WIDTH: 80px" maxLength=50 name="visit_time" value="<s:property value="visit_time"/>">
														到<INPUT class=textbox id="visit_endtime" 
														style="WIDTH: 80px" maxLength=50 name="visit_endtime" value="<s:property value="visit_endtime"/>">
														</TD>
