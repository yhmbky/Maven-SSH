...
<script type="text/javascript">
	$(function(){
		...
		//页面加载，异步查询字典类
		//加载客户来源
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"002"},function(date){
			//遍历json
		...
		//加载客户级别
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"006"},function(date){
			//遍历json
			$(date).each(function(i,n){
		...
		//加载所属行业
		$.post("${pageContext.request.contextPath }/baseDict_findByTypeCode.action",{"dict_type_code":"001"},function(date){
			//遍历json
			$(date).each(function(i,n){
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="custName" value="<s:property value="custName"/>"></TD>
													<td>客户级别 ：</td>
													<td>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												[<A href="javascript:to_page(<s:property value="current-1"/>)">前一页</A>]
												</s:if>
												...
												<s:if test="current!=totalPage">
												[<A href="javascript:to_page(<s:property value="current+1"/>)">后一页</A>] 
												[<A href="javascript:to_page(<s:property value="totalPage"/>)">尾页</A>] 
												</s:if>
												到
												<input type="text" size="3" id="page" name="current" />
												页
